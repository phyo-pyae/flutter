...
import 'package:phyopyaewa_logistics/app/home/entries/daily_jobs_details.dart';
import 'package:phyopyaewa_logistics/app/home/entries/entries_list_tile.dart';
import 'package:phyopyaewa_logistics/app/home/entries/entry_job.dart';
import 'package:phyopyaewa_logistics/app/home/job_entries/format.dart';
...
class EntriesBloc {
  ...
  static List<EntriesListTileModel> _createModels(List<EntryJob> allEntries) {
    ...
    //functional operator used to
    //accumulate over a list of values and return a single result
